...
const DoctorCard = ({ doctor }) => {
  ...
  return (
    <div className="p-3 lg:p-5">
      ...
      <div className="lg-mt-4 mt-2 flex items-center justify-between">
        ...
        <div className="flex items-center gap-[6px]">
          ...
          <span className="flex items-center gap-[6px] text-[14px] leading-6 lg:leading-7 lg:text-[16px] font-[400] text-textColor">
            ({totalRating})
          </span>
        </div>
      </div>
